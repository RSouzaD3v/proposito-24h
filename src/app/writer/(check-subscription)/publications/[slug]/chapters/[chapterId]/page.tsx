...
export default function ChapterPage({ params }: { params: Promise<{ slug: string; chapterId: string }> }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const data = await res.json();
            setChapter(data.chapter);
            router.replace(`/writer/publications/${slug}/chapters`);
        } catch (e) {
            console.log(e);
        }
    };
                    ...
                    <div className="flex-1">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center gap-1 justify-end">
                                <Link className="bg-gray-600 hover:bg-gray-700 transition text-white font-bold py-3 px-8 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-400" 
